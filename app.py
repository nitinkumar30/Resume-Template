...
st.write('\n')
st.caption('Developed with ❤ by [Nitin Kumar](https://www.linkedin.com/in/nitin30kumar/). Kindly support this [Resume '
           'Template](https://github.com/nitinkumar30/Resume-Template) by giving a 🌟.')
